...
import "./index.css";
import servicesData from "../../Data/services/InjectionCosmetologyPart2.json";

function InjectionCosmetologyPart2() {
  return (
    <>
      ...
      <div className="AestheticCosmetology__content">
        ...
        <div className="AestheticCosmetology__services__container">
          ...
          <div className="InjectionCosmetology__discount">
            <div className="InjectionCosmetology__discount_container">
...
export default InjectionCosmetologyPart2;
