...
import "./index.css";
import servicesData from "../../Data/services/AestheticCosmetology.json";

function AestheticCosmetology() {
  return (
    <>
        ...
        <div className="AestheticCosmetology__services_list">
          <div className="AestheticCosmetology__services__container">
            {servicesData.services.map((service) => (
              <div className={`AestheticCosmetology__services ${service.size}`}>
...
export default AestheticCosmetology;
