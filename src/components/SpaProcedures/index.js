...
import "./index.css";
import servicesData from "../../Data/services/SpaProcedures.json";

function SpaProcedures() {
  return (
    <>
      ...
      <div className="AestheticCosmetology__content">
        ...
        <div className="AestheticCosmetology__services__container">
          ...
          <div className="SpaProcedures__discount">
            <div className="SpaProcedures__discount_container">
